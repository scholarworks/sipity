      ...
      context '#processing_state_names_for_select_within_work_area' do
        ...
        it 'will return actions associated with the work area' do
          ...
          expect(subject).to eq(
            [
              "advisor_changes_requested", "back_from_cataloging", "grad_school_changes_requested", "new", "ready_for_cataloging",
              "ready_for_ingest", "under_advisor_review", "under_grad_school_review"
            ]
          )
        end
      end

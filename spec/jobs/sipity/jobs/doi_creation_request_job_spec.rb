...
module Sipity
  module Jobs
    RSpec.describe DoiCreationRequestJob do
      ...
      subject { described_class.new(doi_creation_request.id) }
      before do
      ...
      context '#work' do
        ...
        it 'will transition the state to ' do
          ...
          allow(doi_creation_request).to receive(:update).with(state: doi_creation_request.class::REQUEST_SUBMITTED)
          subject.work
        end
      end
    end

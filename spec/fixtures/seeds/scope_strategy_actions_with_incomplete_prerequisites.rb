...
Sipity::Models::Processing::EntityActionRegister.create!([
  {strategy_action_id: 4, entity_id: 1, requested_by_identifier_id: 1, on_behalf_of_identifier_id: 1, subject_id: 1, subject_type: 'Sipity::Models::Processing::Entity'}
])
Sipity::Models::Processing::EntitySpecificResponsibility.create!([
  {strategy_role_id: 1, entity_id: 1, identifier_id: 1}
])

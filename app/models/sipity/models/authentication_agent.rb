...
module Sipity
  module Models
    ...
    module AuthenticationAgent
      ...
      Contract(KeywordArgs[user_id: Or[String, Integer]] => Sipity::Interfaces::AuthenticationAgentInterface)
      def self.new_from_user_id(user_id:)
        user = User.find(user_id)
        Sipity::Models::AuthenticationAgent::FromDevise.new(user: user)
      end

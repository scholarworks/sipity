...
module Sipity
  module Models
    ...
    class AdditionalAttribute < ActiveRecord::Base
      ...
      ALLOW_PRE_PRINTS_PREDICATE_NAME = 'allow_pre_prints'.freeze
      ...
      COURSE_PREDICATE_NAME = 'course'.freeze
      ...
      QUALITY_OF_RESEARCH_PREDICATE_NAME = 'quality_of_research'.freeze
      RESOURCE_CONSULTED_NAME = 'resource_consulted'.freeze
      SPATIAL_COVERAGE = 'spatial_coverage'.freeze
      SUBJECT = 'subject'.freeze
      SUPERVISING_SEMESTER_PREDICATE_NAME = 'supervising_semester'.freeze
      ...
      enum(
        key: {
          ...
          ALLOW_PRE_PRINTS_PREDICATE_NAME => ALLOW_PRE_PRINTS_PREDICATE_NAME,
          ...
          COURSE_PREDICATE_NAME => COURSE_PREDICATE_NAME,
          ...
          QUALITY_OF_RESEARCH_PREDICATE_NAME => QUALITY_OF_RESEARCH_PREDICATE_NAME,
          RESOURCE_CONSULTED_NAME => RESOURCE_CONSULTED_NAME,
          SPATIAL_COVERAGE => SPATIAL_COVERAGE,
          SUBJECT => SUBJECT,
          SUPERVISING_SEMESTER_PREDICATE_NAME => SUPERVISING_SEMESTER_PREDICATE_NAME,

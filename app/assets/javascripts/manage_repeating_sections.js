...
(function($){
  $.widget( "sipity.manage_sections", {
    ...
    _create: function() {
      ...
      $('.repeat', this.element).append(this.controls);
      $('.repeat:not(:last-child) .field-controls', this.element).append(this.remover);
    ...
    add_to_section_list: function( event ) {
      ...
      if ($activeField.children('td.name').first().children('div').children('input').val() === '') {

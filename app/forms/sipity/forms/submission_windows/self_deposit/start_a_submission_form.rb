      ...
      module SelfDeposit
        ...
        class StartASubmissionForm
          ...
          def possible_work_types
            DataGenerators::WorkTypes::SelfDepositGenerator::WORK_TYPE_NAMES
          end
          ...
          def initialize_work_area_and_submission_window!(submission_window:)
            @work_area = repository.find_work_area_by(slug: DataGenerators::WorkAreas::SelfDepositGenerator::SLUG)

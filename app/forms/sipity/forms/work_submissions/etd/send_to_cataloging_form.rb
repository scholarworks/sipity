...
module Sipity
  module Forms
    module WorkSubmissions
      module Etd
        # Responsible for submitting the final Grad School approval and mark it for cataloging.
        class SendToCatalogingForm
          ...
          def legend
            view_context.t('etd/send_to_cataloging', scope: 'sipity/forms.state_advancing_actions.legend').html_safe
          end

          def signoff_agreement
            view_context.t('i_agree', scope: 'sipity/forms.state_advancing_actions.verification.etd/send_to_cataloging').html_safe
          end
